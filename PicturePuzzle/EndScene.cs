...
public class EndScene : BaseScene
{
    ...
    {
        string statusText = $"Game " + (_hasWon ? "Won!" : "Lost!");
        Vector2 statusTextMiddlePoint = _04BFont.MeasureString(statusText) / 2;
        Vector2 statusTextPos = new Vector2(_game1.Window.ClientBounds.Width / 2,
            _hasWon ? _game1.Window.ClientBounds.Height / 2 - 100 : _game1.Window.ClientBounds.Height / 2);
        spriteBatch.DrawString(_04BFont, statusText, statusTextPos,
            new Color(84, 8, 4), 0, statusTextMiddlePoint, 3f, SpriteEffects.None, 0.5f);
        ...
        if (_hasWon)
        {
            ...
            spriteBatch.DrawString(_04BFont, movesText, movesTextPos,
                new Color(84, 8, 4), 0, movesTextMiddlePoint, 1.5f, SpriteEffects.None, 0.5f);
            ...
            spriteBatch.DrawString(_04BFont, timeText, timeTextPos,
                new Color(84, 8, 4), 0, timeTextMiddlePoint, 1.5f, SpriteEffects.None, 0.5f);
        }
